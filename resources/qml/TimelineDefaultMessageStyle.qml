...
TimelineEvent {
    ...
    property int avatarMargin: (wrapper.isStateEvent ? 0 : (Nheko.avatarSize * (Settings.timelineSmallAvatarsEnabled ? 0.5 : 1) + 8)) // align with avatar
    ...
    data: [
        ...
        Row {
            ...
            DragHandler {
                id: replyDragHandler
                enabled: Settings.swipeGesturesEnabled
                yAxis.enabled: false
                xAxis.enabled: true
