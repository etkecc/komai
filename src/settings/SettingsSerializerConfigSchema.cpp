...
const std::array<BoolSettingDescriptor, 38> BoolSettings{
  ...
  BoolSettingDescriptor{SettingKey::SidebarsRoomListScrollbarsEnabled,
                        true,
                        &UserSettings::sidebarsRoomListScrollbarsEnabled,
                        &UserSettings::setSidebarsRoomListScrollbarsEnabled},
  ...
  BoolSettingDescriptor{SettingKey::ComposerExtrasStickersEnabled,
                        false,
                        &UserSettings::composerExtrasStickersEnabled,
                        &UserSettings::setComposerExtrasStickersEnabled},
  ...
  BoolSettingDescriptor{SettingKey::UiAvatarsCircular,
                        false,
                        &UserSettings::uiAvatarsCircular,
                        &UserSettings::setUiAvatarsCircular},
  BoolSettingDescriptor{SettingKey::UiAvatarsIdenticonFallback,
                        true,
                        &UserSettings::uiAvatarsIdenticonFallback,
                        &UserSettings::setUiAvatarsIdenticonFallback},
  ...
  BoolSettingDescriptor{SettingKey::PrivacyWindowFocusBlurEnabled,
                        false,
                        &UserSettings::privacyWindowFocusBlurEnabled,
                        &UserSettings::setPrivacyWindowFocusBlurEnabled},
  ...
  BoolSettingDescriptor{SettingKey::NetworkTlsEnableCertificateValidation,
                        ...
                        &UserSettings::networkTlsEnableCertificateValidation,
  ...
  BoolSettingDescriptor{SettingKey::TimelineMessagesLayoutSmallAvatars,
                        false,
                        &UserSettings::timelineMessagesLayoutSmallAvatars,
                        &UserSettings::setTimelineMessagesLayoutSmallAvatars},
  BoolSettingDescriptor{SettingKey::TimelineMessagesLayoutShowOwnAvatar,
                        true,
                        &UserSettings::timelineMessagesLayoutShowOwnAvatar,
                        &UserSettings::setTimelineMessagesLayoutShowOwnAvatar},
  ...
  BoolSettingDescriptor{SettingKey::CallsScreensharePictureInPicture,
                        true,
                        &UserSettings::callsScreensharePictureInPicture,
                        &UserSettings::setCallsScreensharePictureInPicture},
  BoolSettingDescriptor{SettingKey::CallsScreenshareIncludeRemoteVideo,
                        false,
                        &UserSettings::callsScreenshareIncludeRemoteVideo,
                        &UserSettings::setCallsScreenshareIncludeRemoteVideo},
  BoolSettingDescriptor{SettingKey::CallsScreenshareShowCursor,
                        settings::core::definitions::kDefaultScreenShareShowCursor,
                        &UserSettings::callsScreenshareShowCursor,
                        &UserSettings::setCallsScreenshareShowCursor},
  ...
  BoolSettingDescriptor{SettingKey::ComposerInputMarkdownEnabled,
                        true,
                        &UserSettings::composerInputMarkdownEnabled,
                        &UserSettings::setComposerInputMarkdownEnabled},
  BoolSettingDescriptor{SettingKey::TimelineMediaOpenImagesExternal,
                        false,
                        &UserSettings::timelineMediaOpenImagesExternal,
                        &UserSettings::setTimelineMediaOpenImagesExternal},
  BoolSettingDescriptor{SettingKey::TimelineMediaOpenVideosExternal,
                        false,
                        &UserSettings::timelineMediaOpenVideosExternal,
...
const std::array<IntSettingDescriptor, 4> IntSettings{
  ...
  IntSettingDescriptor{SettingKey::TimelineMessagesMaxWidthPx,
                       ...
                       &UserSettings::timelineMessagesMaxWidthPx,
                       &UserSettings::setTimelineMessagesMaxWidthPx},
  IntSettingDescriptor{SettingKey::PrivacyWindowFocusBlurDelaySeconds,
                       kDefaultPrivacyWindowFocusBlurDelaySeconds,
                       &UserSettings::privacyWindowFocusBlurDelaySeconds,
                       &UserSettings::setPrivacyWindowFocusBlurDelaySeconds},
  IntSettingDescriptor{SettingKey::CallsScreenshareFrameRate,
                       kDefaultScreenShareFrameRate,
                       &UserSettings::callsScreenshareFrameRate,
                       &UserSettings::setCallsScreenshareFrameRate},
};
...
const std::array<StringSettingDescriptor, 9> StringSettings{
  ...
  StringSettingDescriptor{
    ...
    &UserSettings::callsAudioRingtone,
    &UserSettings::setCallsAudioRingtone},
  StringSettingDescriptor{SettingKey::CallsDevicesMicrophone,
                          QString(),
                          &UserSettings::callsDevicesMicrophone,
                          &UserSettings::setCallsDevicesMicrophone},
  StringSettingDescriptor{SettingKey::CallsDevicesCamera,
                          QString(),
                          &UserSettings::callsDevicesCamera,
                          &UserSettings::setCallsDevicesCamera},
  StringSettingDescriptor{SettingKey::CallsDevicesCameraResolution,
                          QString(),
                          &UserSettings::callsDevicesCameraResolution,
                          &UserSettings::setCallsDevicesCameraResolution},
  StringSettingDescriptor{SettingKey::CallsDevicesCameraFrameRate,
                          QString(),
                          &UserSettings::callsDevicesCameraFrameRate,
                          &UserSettings::setCallsDevicesCameraFrameRate},
