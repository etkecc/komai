...
| <img src="../../resources/icons/fluent/assets/Counter/SVG/ic_fluent_counter_24_regular.svg" width="16" height="16"> **Unread indicators** | Show unread emphasis (count badges, row highlight, and left-edge marker) for this filter | On for most filters\* |
...
\*Unread indicators are **off** by default for **All Rooms** and **Low Priority**.

The "All rooms" filter only has the **Unread indicators** option (it is always shown and cannot exclude from itself).
