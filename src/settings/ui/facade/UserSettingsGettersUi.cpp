...
#include "settings/ui/facade/UserSettingsPage.h"
    ...
    bool UserSettings::messageHoverHighlight() const
    {
        if (const auto value =
    ...
    bool UserSettings::enlargeEmojiOnlyMessages() const
    {
        if (const auto value =
    ...
    bool UserSettings::systemTrayEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::systemTrayAutostart() const
    {
        if (const auto value =
    ...
    bool UserSettings::communitiesSidebarVisible() const
    {
        if (const auto value =
    ...
    bool UserSettings::roomListScrollbarsVisible() const
    {
    ...
    bool UserSettings::circularAvatarsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::decryptNotifications() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    bool UserSettings::communityNotificationCountsVisible() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    bool UserSettings::compactRoomList() const
    {
        if (const auto value =
    ...
    bool UserSettings::roomListShowLastMessageTime() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    UserSettings::LastMessagePreview UserSettings::showLastMessagePreview() const
    {
    ...
    bool UserSettings::timelineMediaEffectsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::uiAnimationsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::privacyScreen() const
    {
        if (const auto value =
    ...
    int UserSettings::privacyScreenTimeoutSeconds() const
    {
        if (const auto value =
    ...
    bool UserSettings::markdownEnabled() const
    {
        if (const auto value =
    ...
    UserSettings::SendMessageKey UserSettings::sendMessageKey() const
    {
        if (const auto value =
    ...
    UserSettings::AutoReplaceEmoji UserSettings::autoReplaceEmoji() const
    {
        if (const auto value =
    ...
    bool UserSettings::timelineBubblesEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::timelineSmallAvatarsEnabled() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    bool UserSettings::stickersEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::timelineShowOwnAvatarInBubbleLayout() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    QString UserSettings::pinnedReactions() const
    {
    ...
    UserSettings::ShowSenderUsername UserSettings::showSenderUsername() const
    {
        if (const auto value =
    ...
    int UserSettings::showSenderUsernameLargeRoomThreshold() const { return 16; }
    bool UserSettings::animateImagesOnHover() const
    {
        if (const auto value =
    ...
    bool UserSettings::typingNotificationsEnabled() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    UserSettings::RoomSortOrder UserSettings::roomSortOrder() const
    {
        if (const auto value =
              coreStore_.valueAs<int>(settings::core::SettingId::SidebarsRoomListSort);
            value.has_value() && *value >= static_cast<int>(UserSettings::RoomSortOrder::UnreadFirst_Recent) &&
    ...
    bool UserSettings::timelineMessageActionsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::textSelectionEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::swipeGesturesEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::readReceiptsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::desktopNotificationsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::alertOnIncomingMessages() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    bool UserSettings::hasNotifications() const
    {
        return desktopNotificationsEnabled() || alertOnIncomingMessages();
    }
    int UserSettings::maxTimelineWidth() const
    {
        if (const auto value =
