...
const std::array<BoolSettingDescriptor, 40> BoolSettings{
  BoolSettingDescriptor{SettingKey::AppWindowTrayEnabled, false, &UserSettings::tray, &UserSettings::setTray},
  BoolSettingDescriptor{
    SettingKey::AppStartupStartInTray, false, &UserSettings::startInTray, &UserSettings::setStartInTray},
  BoolSettingDescriptor{SettingKey::NotificationsDesktopEnabled,
                       true,
                       &UserSettings::hasDesktopNotifications,
                       &UserSettings::setDesktopNotifications},
  BoolSettingDescriptor{
  ...
  BoolSettingDescriptor{
    ...
    true,
    &UserSettings::scrollbarsInRoomlist,
    &UserSettings::setScrollbarsInRoomlist},
  BoolSettingDescriptor{SettingKey::TimelineMessageActionsEnabled,
                       true,
                       &UserSettings::showActionButtons,
                       &UserSettings::setShowActionButtons},
  BoolSettingDescriptor{
  ...
  BoolSettingDescriptor{
    SettingKey::ComposerFeedbackReadReceipts, true, &UserSettings::readReceipts, &UserSettings::setReadReceipts},
  BoolSettingDescriptor{
  ...
  BoolSettingDescriptor{
    ...
    true,
    &UserSettings::fancyEffects,
    &UserSettings::setFancyEffects},
  BoolSettingDescriptor{
    SettingKey::UiAvatarsCircular,
    false,
  ...
  BoolSettingDescriptor{
    ...
    true,
    &UserSettings::showRoomListTime,
    &UserSettings::setShowRoomListTime},
  BoolSettingDescriptor{
  ...
  BoolSettingDescriptor{
    ...
    &UserSettings::setUseOnlineKeyBackup},
  BoolSettingDescriptor{
    SettingKey::NetworkTlsDisableCertificateValidation,
    false,
    &UserSettings::disableCertificateValidation,
    &UserSettings::setDisableCertificateValidation},
  BoolSettingDescriptor{
    SettingKey::NetworkHttp3Enabled,
    false,
    &UserSettings::enableHttp3,
    &UserSettings::setEnableHttp3},
  BoolSettingDescriptor{
    SettingKey::UiInputSwipeGestures,
    false,
  ...
  BoolSettingDescriptor{
    SettingKey::CallsScreenshareHideCursor,
    false,
...
const std::array<IntSettingDescriptor, 4> IntSettings{
  IntSettingDescriptor{
    SettingKey::TimelineMessagesMaxWidthPx, kDefaultTimelineMaxWidthPx, &UserSettings::maxTimelineWidth, &UserSettings::setMaxTimelineWidth},
...
const std::array<UintSettingDescriptor, 1> UintSettings{
  UintSettingDescriptor{SettingKey::DbMaxFiles, kDefaultMaxDbs, &UserSettings::maxDbs, &UserSettings::setMaxDbs},
};

const std::array<ULongLongSettingDescriptor, 1> ULongLongSettings{
  ULongLongSettingDescriptor{
    SettingKey::DbMaxSizeBytes,
...
const std::array<DoubleSettingDescriptor, 1> DoubleSettings{
  DoubleSettingDescriptor{SettingKey::UiFontSizePt, kDefaultFontSizePt, &UserSettings::fontSize, &UserSettings::setFontSize},
};

const std::array<StringSettingDescriptor, 9> StringSettings{
  StringSettingDescriptor{
    SettingKey::UiFontFamily, QString(), &UserSettings::font, &UserSettings::setFontFamily},
  StringSettingDescriptor{
    SettingKey::UiFontEmojiFamily, QString(), &UserSettings::emojiFontFamily, &UserSettings::setEmojiFontFamily},
  StringSettingDescriptor{
  ...
  StringSettingDescriptor{
    SettingKey::CallsAudioRingtone, QStringLiteral("Default"), &UserSettings::ringtone, &UserSettings::setRingtone},
  StringSettingDescriptor{
    SettingKey::CallsDevicesMicrophone, QString(), &UserSettings::microphone, &UserSettings::setMicrophone},
  StringSettingDescriptor{
    SettingKey::CallsDevicesCamera, QString(), &UserSettings::camera, &UserSettings::setCamera},
  StringSettingDescriptor{
