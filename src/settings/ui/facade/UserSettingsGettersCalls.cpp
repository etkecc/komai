...
#include "settings/ui/facade/UserSettingsPage.h"
    ...
    QString UserSettings::ringtone() const
    {
        if (const auto value =
    ...
    QString UserSettings::microphone() const
    {
        if (const auto value =
    ...
    QString UserSettings::camera() const
    {
        if (const auto value =
    ...
    QString UserSettings::cameraResolution() const
    {
    ...
    QString UserSettings::cameraFrameRate() const
    {
        if (const auto value = coreStore_.valueAs<std::string>(
    ...
    int UserSettings::screenShareFrameRate() const { return screenShareFrameRate_; }
    bool UserSettings::screenSharePiP() const { return screenSharePiP_; }
    bool UserSettings::screenShareRemoteVideo() const { return screenShareRemoteVideo_; }
    bool UserSettings::screenShareHideCursor() const { return screenShareHideCursor_; }
    bool UserSettings::fallbackCallRelayServerEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::legacyCallsEnabled() const
    {
        if (const auto value =
    ...
    bool UserSettings::shareKeysWithTrustedUsers() const
    {
    ...
    bool UserSettings::onlyShareKeysWithVerifiedUsers() const
    {
        if (const auto value = coreStore_.valueAs<bool>(
    ...
    bool UserSettings::onlineKeyBackupEnabled() const
    {
        if (const auto value =
