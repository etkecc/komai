...
- 📞 [Element Call](element-call.md) -- MatrixRTC calls via embedded QtWebEngine + native matrix-sdk widget driver, the secure-scheme bundle, the postMessage bridge, ringing, and per-target QtWebEngine packaging
