...
ItemDelegate {
    ...
    GridLayout {
        ...
        Label {
            ...
            text: displayName
            color: Qt.darker(roomId ? TimelineManager.roomUserColor(roomId, userid, palette.window, palette.highlight, Settings.timelineUserColorCodingPolicy) : TimelineManager.userColor(userid, palette.window), 1.3)
