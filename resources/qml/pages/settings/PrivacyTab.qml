...
SettingsContent {
    ...
    tabFilter: UserSettingsModel.TabPrivacy

    footerContent: Component {
        Item {
            id: localCacheSectionRoot
            ...
            component CardValueRow: Item {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        Layout.preferredWidth: localCacheSectionRoot.controlWidth
                        Layout.maximumWidth: localCacheSectionRoot.controlWidth
            ...
            component RightAlignedNote: Item {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        textFormat: Text.RichText
                        linkColor: palette.highlight
                        Layout.preferredWidth: localCacheSectionRoot.noteWidth
                        Layout.maximumWidth: localCacheSectionRoot.noteWidth
                        onLinkActivated: function(link) {
                            Komai.openLink(link);
                        }
                    }
            ...
            Connections {
                ...
                function onLocalCacheInfoChanged() {
                    localCacheSectionRoot.refreshLocalCacheInfo();
                }
            }
            ...
            Connections {
                ...
                function onProfileChanged() {
                    localCacheSectionRoot.mediaHint = qsTr("Files can be purged freely. The cache regenerates over time.");
                    localCacheSectionRoot.mediaHintColor = Komai.theme.success;
                    localCacheSectionRoot.refreshLocalCacheInfo();
                }
                        ...
                        ColumnLayout {
                            ...
                            Item {
                                ...
                                RowLayout {
                                    ...
                                    StatusBadge {
                                        visible: localCacheSectionRoot.showDatabaseStatusBadge
                                        text: localCacheSectionRoot.cacheInfo.statusLabel || qsTr("Unknown")
                                        tone: localCacheSectionRoot.statusTone(localCacheSectionRoot.cacheInfo.statusKind || "")
                                        Layout.alignment: Qt.AlignVCenter
                                        Layout.topMargin: Komai.paddingMedium
                                        Layout.bottomMargin: Komai.paddingMedium
                                    }
                            ...
                            Text {
                                ...
                                visible: !!localCacheSectionRoot.cacheInfo.statusDetails
                                text: localCacheSectionRoot.cacheInfo.statusDetails || ""
                                color: localCacheSectionRoot.statusDetailColor(localCacheSectionRoot.cacheInfo.statusKind || "")
                                font.pointSize: Settings.uiFontSizePt
                                wrapMode: Text.Wrap
                            }
                            ...
                            CardLinkValueRow {
                                Layout.leftMargin: Komai.paddingMedium
                                Layout.rightMargin: Komai.paddingMedium
                                Layout.topMargin: localCacheSectionRoot.cacheInfo.statusDetails ? Komai.paddingSmall : Komai.paddingMedium
                                label: qsTr("Backend")
                                value: localCacheSectionRoot.cacheInfo.backend || qsTr("Unavailable")
                                link: "https://en.wikipedia.org/wiki/Lightning_Memory-Mapped_Database"
                                visible: (localCacheSectionRoot.cacheInfo.backend || "") === "LMDB"
                            }
                            ...
                            CardValueRow {
                                ...
                                label: qsTr("Size")
                                value: localCacheSectionRoot.cacheInfo.databaseSizeHuman || qsTr("Unavailable")
                            }
                            ...
                            CardValueRow {
                                ...
                                Layout.rightMargin: Komai.paddingMedium
                                Layout.topMargin: Komai.paddingSmall
                                visible: localCacheSectionRoot.showFormatRow
                                label: qsTr("Format")
                                value: localCacheSectionRoot.cacheInfo.cacheFormat || qsTr("Unavailable")
                            }
                            ...
                            CardValueRow {
                                ...
                                Layout.topMargin: Komai.paddingSmall
                                label: qsTr("Stores")
                                value: localCacheSectionRoot.cacheInfo.namedStoresKnown
                                    ? String(localCacheSectionRoot.cacheInfo.namedStores)
                                    : qsTr("Unavailable")
                            }
                            ...
                            CardValueRow {
                                ...
                                value: localCacheSectionRoot.cacheInfo.joinedRoomsKnown
                                    ? String(localCacheSectionRoot.cacheInfo.joinedRooms)
                                    : qsTr("Unavailable")
                            }
                            ...
                            CardValueRow {
                                ...
                                Layout.topMargin: Komai.paddingSmall
                                label: qsTr("Invites")
                                value: localCacheSectionRoot.cacheInfo.invitesKnown
                                    ? String(localCacheSectionRoot.cacheInfo.invites)
                                    : qsTr("Unavailable")
                            }
                            ...
                            RowLayout {
                                ...
                                Components.KomaiTextField {
                                    ...
                                    text: localCacheSectionRoot.cacheInfo.databasePath || qsTr("Unavailable until login")
                                    readOnly: true
                                    font.pointSize: Settings.uiFontSizePt
                                    Layout.preferredWidth: localCacheSectionRoot.directoryControlWidth
                                    Layout.maximumWidth: localCacheSectionRoot.directoryControlWidth
                                }
                                ...
                                Components.ImageButton {
                                    ...
                                    enabled: !!localCacheSectionRoot.cacheInfo.databasePath
                                    ...
                                    onClicked: {
                                        Clipboard.text = localCacheSectionRoot.cacheInfo.databasePath;
                                        copied = true;
                                ...
                                Components.KomaiButton {
                                    ...
                                    enabled: localCacheSectionRoot.cacheInfo.databasePathExists === true
                                    onClicked: Komai.openLocalPath(localCacheSectionRoot.cacheInfo.databasePath)
                                }
                            }
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Item {
                                ...
                                RowLayout {
                                    ...
                                    Components.KomaiButton {
                                        ...
                                        onClicked: localCacheSectionRoot.purgeMediaCache()
                                    }
                            ...
                            CardValueRow {
                                ...
                                Layout.topMargin: Komai.paddingMedium
                                label: qsTr("Size")
                                value: localCacheSectionRoot.cacheInfo.mediaCacheSizeHuman || qsTr("Unavailable")
                            }
                            ...
                            RowLayout {
                                ...
                                Components.KomaiTextField {
                                    ...
                                    text: localCacheSectionRoot.cacheInfo.mediaCachePath || ""
                                    readOnly: true
                                    font.pointSize: Settings.uiFontSizePt
                                    Layout.preferredWidth: localCacheSectionRoot.directoryControlWidth
                                    Layout.maximumWidth: localCacheSectionRoot.directoryControlWidth
                                ...
                                Components.ImageButton {
                                    ...
                                    enabled: !!localCacheSectionRoot.cacheInfo.mediaCachePath
                                    Layout.preferredWidth: 24
                                    Layout.preferredHeight: 24
                                    image: copied ? ":/icons/icons/ui/checkmark.svg" : ":/icons/icons/ui/copy.svg"
                                    ToolTip.visible: hovered
                                    ToolTip.text: copied ? qsTr("Copied!") : qsTr("Copy to clipboard")
                                    onClicked: {
                                        Clipboard.text = localCacheSectionRoot.cacheInfo.mediaCachePath;
                                        copied = true;
                                ...
                                Components.KomaiButton {
                                    ...
                                    text: qsTr("Browse")
                                    icon.source: "qrc:/icons/icons/ui/open-externally.svg"
                                    enabled: localCacheSectionRoot.cacheInfo.mediaCachePathExists === true
                                    onClicked: Komai.openLocalPath(localCacheSectionRoot.cacheInfo.mediaCachePath)
                                }
                            }
                            ...
                            RightAlignedNote {
                                ...
                                Layout.topMargin: 2
                                Layout.bottomMargin: Komai.paddingMedium
                                text: localCacheSectionRoot.mediaHint
                                textColor: localCacheSectionRoot.mediaHintColor
                            }
                        }
                    }
                }
