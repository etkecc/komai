...
Komai is a [fork](https://en.wikipedia.org/wiki/Fork_(software_development)) of the [nheko](https://nheko.im/nheko-reborn/nheko) Matrix chat application. Neko ([猫](https://en.wiktionary.org/wiki/%E7%8C%AB), in Japanese) means cat 🐱.
...
A fork that is both a playful contrast and a quiet kinship with its upstream.
