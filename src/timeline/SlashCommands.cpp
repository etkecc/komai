...
const std::array<CommandDefinition, 38> kCommands{{
  ...
  {CommandId::Plain,
   ...
   CMD_TR("Send an unformatted message (ignoring the global setting)."),
   "plain unformatted message",
   validateRequiredMessage},
  {CommandId::Rainbow,
   "rainbow",
   "/rainbow ",
   CMD_TR("/rainbow <message>"),
   CMD_TR("Send a message in rainbow colors."),
   "rainbow message effect",
   validateRequiredMessage},
  {CommandId::RainbowMe,
   "rainbowme",
   "/rainbowme ",
   CMD_TR("/rainbowme <message>"),
   CMD_TR("Send /me in rainbow colors."),
   "rainbow emote effect",
   validateRequiredMessage},
  {CommandId::Notice,
   "notice",
   "/notice ",
   ...
   "notice bot message",
   validateRequiredMessage},
  {CommandId::RainbowNotice,
   "rainbownotice",
   "/rainbownotice ",
   CMD_TR("/rainbownotice <message>"),
   CMD_TR("Send a bot message in rainbow colors."),
   "rainbow notice bot message",
   validateRequiredMessage},
  {CommandId::Confetti,
   "confetti",
   "/confetti ",
   CMD_TR("/confetti [message]"),
   CMD_TR("Send a message with confetti."),
   "confetti effect message",
   validateOptionalArguments},
  {CommandId::RainbowConfetti,
   "rainbowconfetti",
   "/rainbowconfetti ",
   CMD_TR("/rainbowconfetti [message]"),
   CMD_TR("Send a message in rainbow colors with confetti."),
   "rainbow confetti effect message",
   validateOptionalArguments},
  {CommandId::Msgtype,
   "msgtype",
   "/msgtype ",
  ...
  {CommandId::Glitch,
   "glitch",
   "/glitch ",
   CMD_TR("/glitch <message>"),
   CMD_TR("Send a glitchy message."),
   "glitch message",
   validateRequiredMessage},
  {CommandId::GradualGlitch,
   "gradualglitch",
   "/gradualglitch ",
   CMD_TR("/gradualglitch <message>"),
   CMD_TR("Send a gradually glitchier message."),
   "gradual glitch message",
   validateRequiredMessage},
  {CommandId::Goto,
   "goto",
   "/goto ",
