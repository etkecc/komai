...
MatrixText {
    ...
    ` + (Settings.uiInputModeTouchEnabled ? `span[data-mx-spoiler] {
        color: transparent;
    ...
    enabled: !isReply
    font.pointSize: (Settings.timelineMessagesEmojiOnlyEnlarge && isOnlyEmoji > 0 && isOnlyEmoji < 4) ? Settings.fontSize * 3 : Settings.fontSize
